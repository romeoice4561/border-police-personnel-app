...
import { LayoutDashboard, Users, Search, BarChart3, ClipboardCheck, Images, UserCheck, SlidersHorizontal, UserCircle, PanelLeftClose, PanelLeftOpen, Radar, FileSpreadsheet, Award, ShieldAlert, GitCompareArrows, FilePlus2, ScanSearch, Network, BellRing } from "lucide-react";
...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/commander-reports", labelKey: "nav.commanderReports", icon: FileSpreadsheet, permission: "dashboard.view" },
      { href: "/commander-promotion", labelKey: "nav.commanderPromotion", icon: Award, permission: "dashboard.view" },
