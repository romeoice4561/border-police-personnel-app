/**
 * Commander Intelligence Center — Legacy (Phase 49B/50).
 *
 * Relocated from /commander-intelligence in Phase 52.2 for regression/reference.
 * Business semantics unchanged: ONE loadCommanderIntelligenceCenterPageData() call.
 */
...
export default async function CommanderIntelligenceLegacyPage() {
