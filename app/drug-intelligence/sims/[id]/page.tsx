...
import { ArrowLeft, CreditCard, Users, FileSpreadsheet, Network, History } from "lucide-react";
      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/drug-intelligence/timeline?simId=${encodeURIComponent(simId)}`}>
