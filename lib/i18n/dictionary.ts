...
export const DICTIONARY = {
  ...
  "di.rel.badgeDirectHint": tr("ความเชื่อมโยงจากข้อมูลที่บันทึกโดยตรง", "Directly recorded relationship"),
  "di.rel.badgeInferredHint": tr("ความเชื่อมโยงที่อนุมานจากข้อมูลร่วมกัน", "Relationship inferred from shared recorded data"),
  ...
  "di.rel.expand": tr("ขยายความสัมพันธ์", "Expand relationship"),
  "di.rel.openNetwork": tr("เปิดเป็นผัง", "Open as network"),
  "di.rel.viewTimeline": tr("ดู Timeline", "View Timeline"),
  "di.rel.viewMap": tr("ดู Map", "View Map"),
