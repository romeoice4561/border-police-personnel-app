...
export const DICTIONARY = {
  ...
  "di.map.title":                  tr("แผนที่ข่าวกรองยาเสพติด", "Drug Intelligence Map"),
  "di.map.subtitle":               tr("จุดที่บันทึกไว้จากคดียาเสพติด — ไม่ใช่การวิเคราะห์เส้นทางหรือพื้นที่ต้องสงสัย", "Recorded points from drug cases — not a route or suspected-area analysis"),
