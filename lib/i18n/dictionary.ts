...
export const DICTIONARY = {
  ...
  "di.board.conflictTitle": tr("บอร์ดนี้ถูกบันทึกจากอีกเซสชัน", "This board was saved in another session"),
  "di.board.conflictBody": tr("ไม่สามารถเขียนทับเวอร์ชันล่าสุดได้ โหลดเวอร์ชันล่าสุด หรือบันทึกเป็นสำเนาจากสถานะที่บันทึกไว้ล่าสุด", "The latest version cannot be overwritten. Reload the latest board or save a copy from the last saved state."),
  ...
  "di.board.hydrateNotice": tr("กราฟล่าสุดเปลี่ยนแปลง — ไม่พบ {orphanCount} รายการ และเส้นที่บันทึกไว้ {droppedRouteCount} เส้นถูกตัดออก", "The live graph changed — {orphanCount} items are missing and {droppedRouteCount} saved routes were dropped"),
