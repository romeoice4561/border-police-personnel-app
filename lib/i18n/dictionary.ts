...
export const DICTIONARY = {
  ...
  "di.search.centerDescription": tr(
    "ค้นหาข้อมูลทั่วไป หรือค้นหาความเชื่อมโยงจากหลักฐานที่มีในระบบ",
    "Run a general search or find evidence-backed relationships in recorded data"
  ),
  ...
  "di.rel.sourceSection": tr("สิ่งที่ต้องการค้น", "What to search from"),
  "di.rel.relationSection": tr("ความสัมพันธ์", "Relationship"),
  "di.rel.targetSection": tr("สิ่งที่ต้องการหา", "What to find"),
  "di.rel.sourceType": tr("ประเภทข้อมูล", "Entity type"),
  "di.rel.selectEntity": tr("ค้นหาและเลือกข้อมูล", "Search and select an entity"),
  "di.rel.selectedEntity": tr("ข้อมูลที่เลือก", "Selected entity"),
  "di.rel.clearEntity": tr("ล้างการเลือก", "Clear selection"),
  "di.rel.relationPlaceholder": tr("เลือกความสัมพันธ์", "Choose a relationship"),
  "di.rel.targetType": tr("ประเภทที่ต้องการหา", "Target type"),
  ...
  "di.rel.targetRequiredHint": tr("ต้องเลือกข้อมูลปลายทาง", "A target entity is required"),
  "di.rel.searchButton": tr("ค้นหาความเชื่อมโยง", "Search relationships"),
  "di.rel.presetsLabel": tr("ทางลัด", "Shortcuts"),
  "di.rel.promptEmpty": tr("เลือกข้อมูลและความสัมพันธ์ที่ต้องการค้นหา", "Select an entity and relationship to search"),
  ...
  "di.rel.evidenceLabel": tr("หลักฐาน / บริบท", "Evidence / context"),
  "di.rel.pathHops": tr("เส้นทาง {count} ขั้น", "{count}-hop path"),
  "di.rel.queryConditionNote": tr("เงื่อนไขคำถามนี้ไม่ใช่ข้อเท็จจริงในระบบ", "This query condition is not stored as a fact"),
