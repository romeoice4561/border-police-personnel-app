...
export const DICTIONARY = {
  ...
  "di.command.areasHighInPeriod": tr("จำนวนคดีสูงในช่วงที่เลือก", "Highest case count in the selected period"),
  "di.command.areasInPeriod": tr("จำนวนคดีในช่วงที่เลือก", "Case count in the selected period"),
  ...
  "di.command.signalsNote": tr("สัญญาณที่ระบบตรวจพบจากข้อมูลที่บันทึก — ควรตรวจสอบ ไม่ใช่ข้อสรุป", "Signals detected from recorded data — for review, not conclusions"),
  "di.command.signalEvidenceCaution": tr("พบตัวระบุร่วมในหลายคดี — ควรตรวจสอบ ไม่ใช่ข้อสรุปความเชื่อมโยงทางอาญา", "The same identifier appears in multiple cases — for review, not a proven criminal link"),
  "di.command.signalRelatedCases": tr("พบการอ้างอิง {count} ครั้ง", "Referenced {count} times"),
  "di.command.signalStatusNew": tr("ยังไม่ได้ตรวจสอบ", "Unreviewed"),
  ...
  "di.command.actionCenterNote": tr("คิวงานจากข้อมูลที่มีอยู่ — ไม่ใช่คำแนะนำจากระบบอัตโนมัติ", "Workflow queue from existing data — not generated advice"),
  "di.command.actionCenterEmpty": tr("ไม่มีรายการค้างสำหรับขอบเขตนี้", "No pending items for this scope"),
  "di.command.actionOpen": tr("เปิดรายการ", "Open"),
  "di.command.actionDuplicates": tr("ตรวจสอบข้อมูลซ้ำ", "Review Duplicates"),
  "di.command.actionDuplicatesWhy": tr("คู่ข้อมูลบุคคลที่รอตรวจสอบซ้ำ — คิวปัจจุบัน", "Person pairs waiting for duplicate review — current queue"),
  "di.command.actionAlerts": tr("ดูรายการแจ้งเตือน", "View Alerts"),
  "di.command.actionNewSignals": tr("สัญญาณใหม่ที่ยังไม่ได้ตรวจสอบ", "New unreviewed signals"),
  "di.command.actionNewSignalsWhy": tr("รายการแจ้งเตือนสถานะใหม่ — คิวปัจจุบัน ไม่จำกัดตามช่วงเวลา", "Alerts in NEW status — current queue, not period-bounded"),
  "di.command.actionMissingArrested": tr("คดีที่ขาดข้อมูลผู้ถูกจับ/ผู้ต้องหา", "Cases missing arrested/accused persons"),
  "di.command.actionMissingArrestedWhy": tr("คดีในช่วงที่เลือกที่ยังไม่มีบทบาทผู้ถูกจับกุมหรือผู้ต้องหา", "Selected-period cases with no arrested/accused role"),
  "di.command.actionUnassignedUnit": tr("คดีที่ยังไม่ระบุหน่วยรายงาน", "Cases with no reporting unit"),
  "di.command.actionUnassignedUnitWhy": tr("ข้อมูลยังไม่ระบุหน่วยรายงานในระดับที่กำลังแสดง", "Reporting unit is still unspecified at the ranking level"),
  "di.command.actionMissingCoords": tr("คดีที่ยังไม่มีพิกัด", "Cases missing coordinates"),
  "di.command.actionMissingCoordsWhy": tr("คดีในช่วงที่เลือกที่ยังไม่มีละติจูดหรือลองจิจูด — เปิดแผนที่เพื่อดูรายการ", "Selected-period cases without latitude or longitude — open the map list"),
  "di.command.situationTitle": tr("สรุปสถานการณ์", "Situation summary"),
  "di.command.situationNote": tr("ข้อความนี้อ่านจากตัวเลขที่คำนวณได้เท่านั้น ไม่ใช่ข้อสรุปจากระบบอัตโนมัติ", "These notes are generated only from computed metrics — not automated conclusions"),
  "di.command.situationOpen": tr("ดูข้อมูลจริง", "View the records"),
  "di.command.comparisonScope": tr("เปรียบเทียบกับ", "Compared with"),
  "di.command.comparisonPrevious": tr("ช่วงก่อนหน้าเทียบเท่า", "Equivalent previous period"),
  "di.command.readinessTitle": tr("ความพร้อมของข้อมูล", "Data readiness"),
  "di.command.readinessNote": tr("สัดส่วนคดีในช่วงที่เลือกที่ยังขาดข้อมูลสำคัญ — ไม่แสดงรายละเอียดบุคคล", "Share of selected-period cases still missing key fields — no personal records"),
  "di.command.readinessOfPeriod": tr("ของคดีในช่วงที่เลือก", "of cases in the selected period"),
  "di.command.readinessMissingUnit": tr("ยังไม่ระบุหน่วยรายงาน", "Missing reporting unit"),
  "di.command.readinessMissingCoords": tr("ยังไม่มีพิกัด", "Missing coordinates"),
  "di.command.readinessMissingArrested": tr("ยังไม่มีผู้ถูกจับ/ผู้ต้องหา", "No arrested/accused link"),
  "di.command.readinessIncompleteSeizure": tr("ของกลางยังไม่จัดประเภทครบ", "Incomplete seizure category"),
  ...
  "di.command.viewCases": tr("ดูรายการคดี", "View Cases"),
  "di.command.viewMap": tr("ดูแผนที่", "View Map"),
  "di.command.openNetwork": tr("เปิดผังความเชื่อมโยง", "Open Network"),
  "di.command.openSearch": tr("ค้นหาความเชื่อมโยง", "Relationship Search"),
