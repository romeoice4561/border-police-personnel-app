 ...
 * can offer "ตชด.ภ.4" as a friendly label while still resolving to the real
 * seeded Region row.
 *
...
export const BORDER_PATROL_DIVISION_DEFAULTS: readonly BorderPatrolDivisionOption[] = [
  { regionCode: "1", label: "ตชด.ภ.1" },
  { regionCode: "2", label: "ตชด.ภ.2" },
  { regionCode: "3", label: "ตชด.ภ.3" },
  { regionCode: "4", label: "ตชด.ภ.4" },
];
 ...
 * only its `code` (e.g. "4") and `nameTh` (e.g. "ภาค 4") — "ตชด.ภ.4" when a
