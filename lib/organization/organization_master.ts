...
/**
 * Division ("ภาค N") code -> its battalion codes, in display order.
 *
 * Divisions 5-7 have no battalion/company data yet — they exist here only so
 * consumers with legacy data referencing them (e.g. Gallery assets tagged
 * "ภาค 5"/"ภาค 6"/"ภาค 7") still have a valid dropdown option, matching what
 * was previously a separate hardcoded THAI_REGIONS list in
 * gallery_edit_modal.tsx. The Border Patrol Battalion/Company hierarchy
 * (BATTALIONS below) is only defined for divisions 1-4.
 */
