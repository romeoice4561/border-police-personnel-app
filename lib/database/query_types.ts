...
import type { Officer, Timeline, Unit, Phone } from "@/lib/database/database_types";

export type { Officer, Timeline, Unit, Phone };

/** An officer with its related timeline and phones (for the full-profile endpoint). */
