...
test("officer row uses the revised 'รอการแต่งตั้งมาแล้ว' semantics (overdueYears - 1) and Buddhist-Era retirement year", () => {
  const csv = buildCommanderExportCsv([fakeOfficer()], {
    titleTh: "t",
    filtersAppliedTh: [],
    resultCount: 1,
  ...
  assert.match(dataRow, /1 ปี/); // overdueYears=2 -> 1 missed opportunity
