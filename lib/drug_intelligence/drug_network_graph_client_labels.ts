...
export const DRUG_GRAPH_RELATIONSHIP_SHORT_LABEL_KEY: Record<DrugGraphRelationshipType, TranslationKey> = {
  PERSON_CASE: "di.network.relOpPersonCase",
  PERSON_PHONE: "di.network.relOpPersonPhone",
  PERSON_SIM: "di.network.relOpPersonSim",
  PERSON_DEVICE: "di.network.relOpPersonDevice",
  PERSON_VEHICLE: "di.network.relOpPersonVehicle",
  CASE_PHONE: "di.network.relOpFoundInCase",
  CASE_SIM: "di.network.relOpFoundInCase",
  CASE_DEVICE: "di.network.relOpFoundInCase",
  CASE_VEHICLE: "di.network.relOpFoundInCase",
  CASE_LOCATION: "di.network.relOpFoundAt",
