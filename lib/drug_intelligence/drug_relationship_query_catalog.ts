...
export const DRUG_CONTROLLED_RELATIONS: readonly DrugControlledRelationDefinition[] = [
  // ── DI-8.3 overview: all evidence-backed neighbors ────────────────────
  {
    id: "person_all_related",
    sourceTypes: ["PERSON"],
    targetTypes: ["CASE", "PERSON", "PHONE", "SIM", "DEVICE", "VEHICLE", "LOCATION"],
    ...
    targetOptional: true,
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All DIRECT + SHARED_* neighborhood edges for overview grouping",
  },
  {
    id: "phone_all_related",
    sourceTypes: ["PHONE"],
    targetTypes: ["CASE", "PERSON", "SIM", "DEVICE", "VEHICLE", "LOCATION"],
    graphRelationshipType: null,
    edgeKind: "DIRECT",
    queryMode: "NEIGHBORHOOD",
    neighborhoodDepth: 2,
    ...
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All evidence-backed phone neighborhood edges",
  },
  {
    id: "sim_all_related",
    sourceTypes: ["SIM"],
    targetTypes: ["CASE", "PERSON", "PHONE", "DEVICE", "VEHICLE", "LOCATION"],
    graphRelationshipType: null,
    edgeKind: "DIRECT",
    queryMode: "NEIGHBORHOOD",
    neighborhoodDepth: 2,
    ...
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All evidence-backed SIM neighborhood edges",
  },
  {
    id: "device_all_related",
    sourceTypes: ["DEVICE"],
    targetTypes: ["CASE", "PERSON", "PHONE", "SIM", "VEHICLE", "LOCATION"],
    graphRelationshipType: null,
    edgeKind: "DIRECT",
    queryMode: "NEIGHBORHOOD",
    neighborhoodDepth: 2,
    ...
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All evidence-backed device/IMEI neighborhood edges",
  },
  {
    id: "vehicle_all_related",
    sourceTypes: ["VEHICLE"],
    targetTypes: ["CASE", "PERSON", "PHONE", "SIM", "DEVICE", "LOCATION"],
    graphRelationshipType: null,
    edgeKind: "DIRECT",
    queryMode: "NEIGHBORHOOD",
    neighborhoodDepth: 2,
    ...
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All evidence-backed vehicle neighborhood edges",
  },
  {
    id: "case_all_related",
    sourceTypes: ["CASE"],
    targetTypes: ["PERSON", "PHONE", "SIM", "DEVICE", "VEHICLE", "LOCATION"],
    graphRelationshipType: null,
    edgeKind: "DIRECT",
    queryMode: "NEIGHBORHOOD",
    neighborhoodDepth: 1,
    ...
    mvpAvailable: true,
    labelKey: "di.rel.allRelated",
    evidenceSemantics: "All DIRECT case membership edges",
  },
