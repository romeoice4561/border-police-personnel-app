...
/** DI-11E.3: batch related-result-note read is first-page only. Per-task routes paginate further. */
export const RELATED_TASK_NOTES_BATCH_MAX_IDS = COLLABORATION_PAGE_DEFAULT;
export const RELATED_TASK_NOTES_BATCH_RAW_MAX = COLLABORATION_PAGE_MAX;
export const RELATED_TASK_NOTES_BATCH_MAX_ITEMS = RELATED_TASK_NOTES_BATCH_MAX_IDS * COLLABORATION_PAGE_DEFAULT;
