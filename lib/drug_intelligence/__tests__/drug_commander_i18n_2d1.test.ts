...
test("Phase 2D Commander Thai labels match the agreed commander language", () => {
  const expected: Array<[TranslationKey, string]> = [
    ...
    ["di.command.attentionTitle", "เรื่องที่ควรตรวจสอบ"],
    ["di.command.attentionReview", "ควรตรวจสอบ"],
    ["di.command.attentionComplete", "ควรเติมข้อมูล"],
    ...
    ["di.command.readinessNotScore", "วัดความครบถ้วนของข้อมูล ไม่ใช่ผลการปฏิบัติของหน่วย และไม่ใช่ความเสี่ยงทางอาญา"],
